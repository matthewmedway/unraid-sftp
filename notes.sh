...
docker run -d -t -i --name='unraid-sftp-test' --net='bridge' -e TZ="America/New_York" -e 'username'='sftpuser' -e 'password'='test123' -e 'publickey'='ssh-rsa  rsa-key-20190309' -p '22222:22/tcp' -v '/home/matthew/sftpdata':'/data':'rw' 'drbrocoli/unraid-sftp' 